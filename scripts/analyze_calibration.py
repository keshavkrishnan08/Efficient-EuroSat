...
def main():
    ...
    # --- Load models ------------------------------------------------------
    print("\nLoading UCAT model...")
    ucat_model, ucat_config = load_model(args.checkpoint_ucat, device, dataset_name=args.dataset)
    print(f"  Model type: {ucat_config.get('model_type', 'efficient_eurosat')}")

    print("Loading baseline model...")
    baseline_model, baseline_config = load_model(args.checkpoint_baseline, device, dataset_name=args.dataset)
